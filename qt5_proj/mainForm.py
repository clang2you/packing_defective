...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "当日时段不良"))
        self.comboBox.setItemText(1, _translate("MainWindow", "月不良统计"))
        self.dateEdit.setDisplayFormat(_translate("MainWindow", "M月"))
        ...
        self.label_13.setText(_translate("MainWindow", "刷新时间："))
        self.label_14.setText(_translate("MainWindow", "08:37"))
        self.checkBox.setText(_translate("MainWindow", "每分钟自动刷新"))
        self.pushButton_5.setText(_translate("MainWindow", "手动刷新"))
